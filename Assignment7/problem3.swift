...
protocol CarRepairServiceProvider : ServiceProvider{
    var issueDescription : String {get}
    var carModel : String {get}
}

protocol HomeServiceProvider : ServiceProvider{
...
protocol StudentServicesProvider : ServiceProvider {
    var studentServiceDescription : String {get}
}

class clientA :ServiceProvider, CarRepairServiceProvider {
...
class clientB :ServiceProvider,  HomeServiceProvider {
...
class clientC :ServiceProvider,  StudentServicesProvider {
...
class clientD: ServiceProvider, CarRepairServiceProvider, HomeServiceProvider, StudentServicesProvider {
    var issueDescription : String
    var carModel : String
    var cookingService : String
    var washingService : String
